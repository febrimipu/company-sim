            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">    
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <x-nav-link :href="'#'" :active="request()->routeIs('purchases*')">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('purchases.approvedPurchases')">
                                    {{ __('Approval') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('purchases.purchaseReport')">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6"> 
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <x-nav-link :href="'#'" :active="request()->routeIs('pages*')">
                                    {{ __('Pages') }}
                                </x-nav-link>
                            </x-slot>
                            <x-slot name="content">
